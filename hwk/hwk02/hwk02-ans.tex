...
the CLT we have \(\sqrt{n}(\bar{X} - 4 \beta^2) / 2 \beta = \sqrt{n}(\bar{X} / 2 \beta - 2) \sim \mathrm{N}(0, 1)\). If \(\zgam = \Phi^{-1}((1 + \gamma) / 2)\),
then we have \(\gamma = \mathrm{Pr} (-\zgam \le \sqrt{n}(\bar{X} / 2 \beta - 2 \le \zgam)\). Rearranging to get \(\beta\) in the middle gives us 
\begin{align*}
    \mathcal{I}
    = \left( ~ \frac{\bar{X}}{4(1 + \zgam / \sqrt{n})} ~,~ \frac{\bar{X}}{4(1 - \zgam / \sqrt{n})} ~ \right).
\end{align*}
...
is given by \(\mathcal{I} = ( ~ 5\bar{X} / 28 ~,~ 5 \bar{X} / 12 ~)\). 
