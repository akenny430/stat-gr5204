...
%' ============================================================================================================================================================
\section{Question 5} \noindent
Let \(X_1, \ldots, X_n\) be a random sample from \(X \sim \mathrm{Unif}(\theta, 2\theta)\), where \(\theta > 0\). The likelihood function is then given by 
...
it will be maximized by the smallest possible value of \(\theta\). Therefore, the MLE of \(\theta\) is \(\hat{\theta} = x_{(n)} / 2\).
